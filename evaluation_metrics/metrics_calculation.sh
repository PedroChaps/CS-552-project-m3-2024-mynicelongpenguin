#!/bin/bash -l
#SBATCH --chdir /scratch/izar/aloureir/project-m3-2024-mynicelongpenguin/evaluation_metrics 
#SBATCH --ntasks 1
...
python3 metrics_calculation.py \
    ...
    --metrics_files "default_model_eval_metrics.json,3998_base_model_eval_metrics.json,7997_base_model_eval_metrics.json,7997_model_eval_metrics.json" \
